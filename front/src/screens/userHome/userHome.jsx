        ...
        <View style={{ flex: 1, alignItems: "center" }}>
          ...
          >
            <TouchableOpacity
              ...
              activeOpacity={0.5}
              onPress={() =>
                navigation.navigate("SelectAmount", { map: false })
              }
            >
              <Image
                source={
            ...
            >
              ...
              />
              <Text style={mode ? style.text : style.textDark}>
                Encuentra tu Comercio más cercano
              </Text>
            </TouchableOpacity>
          </View>
                  ...
                  >
                    ...
                    >
                      ...
                      <View style={style.monto}>
                        <Text
                          style={mode ? style.montoTexto : style.montoTextoDark}
                        >
                          ${item.amount}
                        </Text>
                      </View>
